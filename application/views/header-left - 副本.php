...
>>>>>>> .r356
      ...
      <li class="sub-menu"> <a class="" href="javascript:;"> <i class="icon-map-marker"></i> <span>权限管理</span> <span class="arrow"></span> </a>
        <ul class="sub">
          <li><a href="/authManage/auth/index" class="">权限列表信息</a></li>
          <li><a href="/authManage/role/index" class="">角色基础信息</a></li>
          <li><a href="/authManage/authAssignment/index" class="">分配角色权限</a></li>
