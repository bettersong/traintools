    ...
    <div class="container-fluid">
      ...
      <div class="top-nav ">
        <ul class="nav pull-right top-menu" >
          ...
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img class="img-responsive" src="/public/images/user.png" alt="" width="25px" height="25px" /> <span class="username">张三</span> <b class="caret"></b> </a>
  ...
  <div id="sidebar" class="nav-collapse collapse">
    ...
    <ul class="sidebar-menu" id="leftSidebar">
      ...
      <li class="sub-menu"> <a href="javascript:;" class=""> <i class="icon-tasks"></i> <span>工具清点管理</span> <span class="arrow"></span> </a>
        <ul class="sub">
          <li><a class="" href="/toolsManage/clearRecord/index">清点记录</a></li>
        </ul>
      </li>
      ...
      <li class="sub-menu"> <a class="" href="javascript:;"> <i class="icon-map-marker"></i> <span>报表统计</span> <span class="arrow"></span> </a>
       ...
       <li class="sub-menu"> <a href="javascript:;" class=""> <i class="icon-glass"></i> <span>信息发布与管理</span> <span class="arrow"></span> </a>
        <ul class="sub">
          <li><a class="" href="faq.html">信息发布</a></li>
          <li><a class="" href="faq.html">信息管理</a></li>
        </ul>
      </li>
      ...
      <li class="sub-menu"> <a class="" href="javascript:;"> <i class="icon-map-marker"></i> <span>权限管理</span> <span class="arrow"></span> </a>
        <ul class="sub">
          <li><a href="/reportForm/reportForms/index" class="">权限列表信息</a></li>
          <li><a href="/reportForm/peopleForms/index" class="">角色基本信息</a></li>
          <li><a href="/reportForm/equipmentForms/index" class="">分配角色权限</a></li>
