...
var localuserArr =JSON.parse('<?php echo json_encode($localuserArr);?>');//JSON.parse('<,?php echo json_encode($localuserArr);?>') ;
 var markerArr = [];//用来保存被选择用户的经纬度
$(document).ready(function(){
   
 	/** 显示初始人员**/
	var markerList = [];
	$.each(localuserArr, function(i, item){     
        //alert(item['username']);
		var localX=item['localX'];
		var localY=item['localY'];
