...
<div class="row-fluid" id ="gaodeMap">
  ...
  <div class="box_left">
    ...
    <div class="box_left_main" id="textbox">
            ...
            <div class="f-treeList">
              <div class="f-treeList-top">
                ...
                <div class="f-treeList-title">
                  ...
                  <p class="f-treeList-titleP name" localX="<?=$userInfo['localX']?>" tip="姓名"><?=$userInfo['username']?></p></div>
              </div>
            </div>
          </div>
        <?php 
...
<?php }//end catlog1?>
        ...
        <div id="myMenu" >
        <ul>
            <li id="track"><div class="list_icon"><img src="images/guiji.png"></div>轨迹回放</li>
            <li><div class="list_icon"><img src="images/Tourist.png"></div>人员信息</li>
        </ul>
        </div>
        <div id="mask"></div>
      </div>
...
<script src="/public/js/editable-zManage.js?v=0.101"></script>
 <script src="http://webapi.amap.com/maps?v=1.4.3&key=28055c1bc57defef57ccca6411ba31ca&plugin=AMap.Driving"></script>
<script>
var localuserArr =JSON.parse('<?php echo json_encode($localuserArr);?>') ;
console.log(localuserArr);
$(".f-iconRadio").click(function(e) {
    ...
    var lnglats=[
         ...
         [115.866886,28.744562],[115.871467,28.739498]
                ...
                marker=new AMap.Marker({
                    position:lnglats[m-3],
                    map:map,
                    animation:"AMAP_ANIMATION_DROP"
                });
                map.add(marker);
                markerId=(marker._amap_id);
                console.log(marker);
                marker.content='<p>'+'<strong>'+'我是'+localuserArr[m-3].username+'</strong>'+'</p>'+'<p>定位时间：2018-10-22</p>'+'<p> 工作状态：离线</p>' +
                '<p>考勤状态：迟到</p>';
