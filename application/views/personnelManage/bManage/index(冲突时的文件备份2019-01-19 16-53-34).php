                ...
                <div class="span12">
                    ...
                    <div class="widget red">
                        ...
                        <div class="widget-body">
                            <div>
                               <div><img style="width:13px;" src="/public/images/icon-png/bumen.png">表示部门(可添加子项) &nbsp;<img  style="width:13px;vertical-align:text-top;margin-top: 2px;" src="/public/images/icon-png/zhiwei.png">表示职位</div>
...
$(function () {
	...
	$(".editItem").live('click',function(e) {
		...
		if(bumenOrZhiwei==1)inputhtml += '<label><input checked name="addtype" type="radio" value="1" />部门</label>'+
		'<label><input name="addtype" type="radio" value="0" />职位</label>';
		else inputhtml += '<label><input name="addtype" type="radio" value="1" />部门</label>'+
		'<label><input checked name="addtype" type="radio" value="0" />职位</label>';
