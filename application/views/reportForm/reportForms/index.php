    ...
    <div class="widget-body">
        <div>
            ...
            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                ...
                <tbody>
                <?php foreach ($ReportForms as $key => $value) { ?>
                <tr class="">
                    <td class="ids"><?=$value['reFormsId']?></td>
                    <td><?=$value['reFormsMaster']?></td>
                    <td><?=$value['reFormsDate']?></td>
                    <td><?=$value['reFormsStatus']?></td>
...
function editable_save(saveobj){
    ...
    var date = $.trim( saveobj.parents("tr").eq(0).find(".tool").eq(0).val() );
    var status = $.trim( saveobj.parents("tr").eq(0).find(".note").eq(0).val() );
    var type = "add";
