                        ...
                        <div class="widget-body">
                            <div>
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                    <?php foreach ($Cemanage as $key => $value) { ?>
                                    <tr class="">
                                        <td class="ids"><?=$value['ceManageId']?></td>
                                        <td><?=$value['ceManageName']?></td>
                                        <td><?=$value['ceManageAmount']?></td>
                                        <td><?=$value['ceManageTime']?></td>
...
<script src="/public/js/editable-ceManage.js?<?=rand(1,999999)?>"></script>
...
function editable_save(saveobj){
    ...
    var time = $.trim( saveobj.parents("tr").eq(0).find(".time").eq(0).val() );
    var type = "add";
