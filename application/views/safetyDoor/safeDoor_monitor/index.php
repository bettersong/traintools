...
<body class="fixed-top">
 ...
 高铁作业门监控<img style="width:40px; vertical-align: bottom;" src="/public/images/zym_pc3.png" />
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <a href="#">主页</a>
...
<div id="home" class="tab-pane fade in active">
    <div class="widget-body">
        ...
        <a style="color:blue;" href="/application/views/personLocal/RealTimeLocal/localmap&x=<?=$value['ceGPS_x']?>,y=<?=$value['ceGPS_y']?>"><img class='mapPosition' style="height: 22px;" x=<?=$value['ceGPS_x']?> y=<?=$value['ceGPS_y']?> src="/public/images/icon-png/local2.png" /><?=$value['ceGPS_x']?>,<?=$value['ceGPS_y']?></a>
        </td>
        <td><?=$value['ceControlPosition']?></td>
        <td><?=$value['pManageName']?></td>
        
        <td>关</td>
        <td><span style="color:#094">良好</span></td>
