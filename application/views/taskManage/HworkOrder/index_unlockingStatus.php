        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title" style="color:#000">
                    作业门开锁情况查询<span class="adminBumenName">（<?=$_SESSION['userInfo']['adminBumenName']?>）</span>
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <a href="#">主页</a>
            ...
            <div class="span12">
                <div class="widget red">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i><?=$_SESSION['userInfo']['adminBumenName']?> - 作业门开锁情况（按工单查看）</h4>
                    </div>
                            ...
                            <tbody>
                             <?php $i=1;foreach ($AllOrder as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td class="id small"><a id="link" href="/safetyDoor/ceControl/history&orderId=<?=$value['twOrderId']?>&JiHuaDate=<?=$value['JiHuaDate']?>"><?=$value['ZuoYeNR']?></a></td>
                                    </tr>
                                    <?php $i++;} ?>
                            </tbody>
                        </table>
...
$("#searchByDate").click(function(e) {
	...
	if(selectDateVal==""){
		...
		//alert(selectDateVal);
        location.href="/taskManage/HworkOrder/index_unlockingStatus&date1="+date1+"&date2="+date2;
	}
});
</script>
</body>
