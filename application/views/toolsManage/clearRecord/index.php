                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            <table class="table table-striped table-bordered" id="sample_1">
                                ...
                                <tbody>
                                <?php foreach ($ClearRecord as $key => $value) { ?>
                                <tr class="odd gradeX">
                                    <td><?=$value['clrecordId']?></td>
                                    <td><?=$value['clrecordLeader']?></td>
                                    <td><?=$value['clrecordDate']?></td>
                                    <td><?=$value['clrecordStatus']?></td>
                                    <td><?=$value['clrecordNote']?></td>
                                </tr>
                                <?php } ?>
