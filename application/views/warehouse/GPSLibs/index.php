            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title" style="color:#000">
                        GPS定位设备库<span class="adminBumenName">（<?=$_SESSION['userInfo']['adminBumenName']?>）</span>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <a href="#">主页</a>
                ...
                <div class="span12">
                    ...
                    <div class="widget blue">
                        <div class="widget-title">
                            <h4>GPS定位设备库（总数: <?=count($GPSLibs)?>）</h4>
                        ...
                        <div class="widget-body">
                            <div>
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                    <?php foreach ($GPSLibs as $key => $value) { ?>
                                    <tr class="">
                                        <td class="ids"><?=$value['GPSId']?></td>
                                        <td><?=$value['GPSCode']?></td>
                                        <td><?=$value['GPSNote']?></td>
...
<script src="/public/js/editable-toolsGPSLibs.js?<?=rand(1,99999)?>"></script>
...
function editable_save(saveobj){
    ...
    var GPS_code = $.trim( saveobj.parents("tr").eq(0).find(".code").eq(0).val() );
