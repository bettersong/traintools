                        ...
                        <div class="widget-body">
                            <div>
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                    <?php foreach ($RFIDClass as $key => $value) { ?>
                                    <tr class="">
                                        <td class="ids"><?=$value['RFIDClassId']?></td>
                                        <td><?=$value['RFIDClassType']?></td>
                                        <td><?=$value['RFIDClassNote']?></td>
...
<script src="/public/js/editable-RFIDClass.js?<?=rand(1,99999)?>"></script>
