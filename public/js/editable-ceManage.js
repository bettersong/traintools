...
// <td><a href="indexDetail" style="text-decoration:underline;"><?=$value['toListNumber']?></a></td>
            function editRow(oTable, nRow,actionType="edit") {
                ...
                jqTds[1].innerHTML = '<input type="text" class="name " value="' + aData[1] + '">';
                jqTds[2].innerHTML = '<input type="text" class="amount " value="' + aData[2] + '">';
                jqTds[3].innerHTML = '<input type="text" class="type time" value="' + aData[3] + '">';
                //遍历后台获取的类别信息
