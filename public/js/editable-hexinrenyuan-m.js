...
// <td><a href="indexDetail" style="text-decoration:underline;"><?=$value['toListNumber']?></a></td>
            function editRow(oTable, nRow,actionType="edit") {
                ...
                if(actionType=="add")jqTds[2].innerHTML ='<a id="link" href="javascript:void;" style="text-decoration:underline;">'+'<input type="text" class="amount small" value="自动统计" disabled>'+ '</a>';
                else jqTds[2].innerHTML = '<a id="link" href="javascript:void;" style="text-decoration:underline;">'+'<input type="text" class="amount small" value="' + xData + '" disabled>'+ '</a>';
                //jqTds[3].innerHTML = '<input type="text" class="type small" value="' + aData[3] + '">';
                //遍历后台获取的类别信息
                // var devOption = "";
                // $.each(rfidclassArray,function(index,row){
                //     //alert(device_id);
                //      devOption += '<option value="'+row['RFIDClassId']+'">'+row['RFIDClassType']+'</option>';
                // });
                // if(actionType=="add")
                // jqTds[3].innerHTML = '<select class="type" id="select">'+devOption+'</select>';
                // else jqTds[3].innerHTML = '<select class="type" id="select">'+devOption+'</select>';
                if(actionType=="edit")jqTds[3].innerHTML = '<a class="update" href="#">保存</a>';
                else if(actionType=="add")jqTds[3].innerHTML = '<a class="save" href="#">保存</a>';
