    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow,actionType="edit") {
                ...
                jqTds[2].innerHTML = '<input type="text" class="tool small" value="' + aData[2] + '">';
                jqTds[3].innerHTML = '<input type="text" class="note small" value="' + aData[3] + '">';
                ...
                jqTds[6].innerHTML =
                '<button class="label label-success" style="border:none">开</button>&nbsp;'+
                '<button class="label label-warning" style="border:none">关</button>';
            }
            ...
            function saveRow(oTable, nRow) {
                ...
                oTable.fnUpdate('<button class="label label-success" style="border:none">开</button>&nbsp;'+
                '<button class="label label-warning" style="border:none">关</button>', nRow, 6, false);
                oTable.fnDraw();
            }
            ...
            function cancelEditRow(oTable, nRow) {
                ...
                oTable.fnUpdate('<a class="edit" href="">编辑</a>', nRow, 4, false);
                oTable.fnUpdate('<button class="label label-success" style="border:none">开</button>&nbsp;'+
                '<button class="label label-warning" style="border:none">关</button>', nRow, 5, false);
                oTable.fnDraw();
            }
