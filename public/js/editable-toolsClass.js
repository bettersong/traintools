    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow,actionType="edit") {
                ...
                //jqTds[2].innerHTML = '<input type="text" class="type small" value="' + aData[2] + '">';
                ...
                if(actionType=="edit")jqTds[2].innerHTML = '<a class="update" href="#">保存</a>';
                else if(actionType=="add")jqTds[2].innerHTML = '<a class="save" href="#">保存</a>';
