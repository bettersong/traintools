...
var EditableTable = function () {
    ...
    return {
        ...
        init: function () {
            ...
            var rows = $("#editable-sample_order").children("tbody").find("tr").length;//初始化行
            $('#editable-sample_new').live('click',function (e) {
                ...
                //alert("rows="+rows);
                //if(rows<=1){
                    //$("#editable-sample_order").children("tbody").find(".edit").eq(0).click();
                    //alert("rows:"+rows);
                //}
                //else{
                    e.preventDefault();
			...
			$('#editable-sample_order a.delete').live('click', function (e) {
            ...
            $('#editable-sample_order a.cancel').live('click', function (e) {
                e.preventDefault();
            ...
            $('#editable-sample_order a.edit,#editable-sample_order a.save,#editable-sample_order a.update').live('click', function (e) {
                e.preventDefault();
